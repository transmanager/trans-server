...
public abstract class BaseDao<T> {
	...
	protected T getById(long id, Class<T> clazz) {
		...
		// Query query =
		// session.createQuery(String.format("from %s entity where entity.id = :id",
		// clazz.getSimpleName()));
	...
	protected List<T> getByField(String field, String value, Class<T> clazz) {
		...
		// session.beginTransaction();
		// Query query =
		// session.createQuery(String.format("from %s entity where entity.%s = :%s",
		// clazz.getSimpleName(), field, field));
